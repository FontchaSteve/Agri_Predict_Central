...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateOTP = channel.unary_unary(
                '/auth.AuthService/GenerateOTP',
                request_serializer=auth__pb2.GenerateOTPRequest.SerializeToString,
                response_deserializer=auth__pb2.GenerateOTPResponse.FromString,
                _registered_method=True)
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GenerateOTP': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=auth__pb2.GenerateOTPRequest.FromString,
                    response_serializer=auth__pb2.GenerateOTPResponse.SerializeToString,
            ),
    }
...
class AuthService(object):
    ...
    def GenerateOTP(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/auth.AuthService/GenerateOTP',
            auth__pb2.GenerateOTPRequest.SerializeToString,
            auth__pb2.GenerateOTPResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
